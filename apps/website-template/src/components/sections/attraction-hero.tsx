...
export default function AttractionHero({ content }: AttractionHeroProps) {
  return (
    <section className="relative pt-16 h-[calc(30vh+4rem)] min-h-[200px] md:h-[calc(70vh+4rem)] md:min-h-[664px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 px-4 mx-auto max-w-4xl text-center md:px-6">
        ...
        <div className="hidden flex-col gap-3 justify-center md:flex sm:flex-row md:gap-4">
          <Link 
            href={content.ctaButtons.primary.link}
          ...
          >
            ...
            <span className="ml-1">From {content.currency}{content.price}</span>
          </Link>
          
          <a 
            href={content.ctaButtons.secondary.link} 
            target="_blank" 
          ...
          >
            <span className="relative z-10">{content.ctaButtons.secondary.text}</span>
